...
public class Entity {
	...
	boolean attackLaser = false;
	boolean charStat = false;
...
//	public int nextLevelExp;
	public int speak = 0;
	public int coin;
	public int hasKey = 999;
	public static int dialogueType;
//	public static boolean lavaMonAmount = false;
	public boolean sword;
	public Entity currentWeapon;
	public Entity laserWeapon;
	public Entity weaponTemp;
	...
	public final int type_laser = 8;
	public final int type_extras = 9;
	public final int type_open = 10;
